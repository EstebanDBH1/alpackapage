    ...
    <div style={{ backgroundColor: BG, minHeight: '100vh', fontFamily: '"Space Grotesk", sans-serif', color: TEXT }}>
      ...
      <header style={{
        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-10 w-full flex items-center justify-between">
          <div className="flex items-center">
            <AlpacaIcon className="h-8 w-auto" />
          </div>
      ...
      <div style={{ paddingTop: 56 }}>
        ...
        <section style={{ position: 'relative', overflow: 'hidden', backgroundColor: BG }}>
          ...
          <div className="relative max-w-5xl mx-auto px-6 sm:px-10 pt-12 pb-0 md:pt-16 text-center">
            ...
            {/* Product shot (workspace real en Notion) */}
            <div style={{
              position: 'relative',
              maxWidth: 900,
              margin: '0 auto',
              ...
              <img
                src="/bundlevtwo.png"
                alt="Bundle de Prompts en Notion — más de 14 categorías organizadas"
                loading="lazy"
        ...
        <section style={{ backgroundColor: BG }}>
          <div className="max-w-5xl mx-auto px-6 sm:px-10 py-12 md:py-16">
        ...
        ══════════════════════════════════════════ */}
        <section style={{ backgroundColor: BG }}>
          <div className="max-w-3xl mx-auto px-6 sm:px-10 py-12 md:py-16 text-center">
        ...
        ══════════════════════════════════════════ */}
        <section style={{ backgroundColor: BG_WARM, borderTop: `1px solid ${BORDER}`, borderBottom: `1px solid ${BORDER}` }}>
          <div className="max-w-3xl mx-auto px-6 sm:px-10 py-12 md:py-16">
